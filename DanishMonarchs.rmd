...
kings1 <- read.csv("data/Danish_rulers.csv")
glimpse(kings1)

kings2 <- read_csv("data/Danish_rulers.csv", na="na")
glimpse(kings2)

kings3 <- read.csv2("data/Danish_rulers.csv")
glimpse(kings3)

kings4 <- read_csv2( "data/Danish_rulers.csv")
glimpse(kings4)
```
